    ...
    <div className="pt-24 min-h-screen">
      ...
      <div className="grid md:grid-cols-2 gap-0 min-h-[70vh]">
        ...
        <div className="px-10 md:px-16 py-16 flex flex-col justify-center">
          ...
          <h1
            className="text-4xl md:text-5xl text-ink font-normal mb-6 leading-tight"
          ...
          {wine.description && (
            <p
              className="text-ink/70 leading-loose mb-8 text-[14px]"
          ...
          {wine.inStock ? (
            <>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="flex items-center border border-stone">
                  <button
                    ...
                    className="w-10 h-10 flex items-center justify-center text-xl text-ink hover:bg-dust transition-colors"
                  >
                    −
                  </button>
                  <span className="w-10 h-10 flex items-center justify-center body-sm text-ink border-x border-stone">
                    {qty}
                  </span>
                  <button
                ...
                <span className="body-sm text-stone">
                  = {(wine.price * qty).toFixed(0)} €
                </span>
              </div>
              ...
              <button
                onClick={handleAdd}
                className={`w-full label-caps py-4 px-6 transition-all duration-300 ${
                  added
                    ? "bg-sage text-cream"
